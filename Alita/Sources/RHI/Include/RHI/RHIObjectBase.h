...
#ifndef RHI_RHIOBJECTBASE_H
#define RHI_RHIOBJECTBASE_H
...
{
protected:
    RHIObjectBase(Device* device, RHIObjectType objectType);
    
    RHIObjectBase(RHIObjectType objectType);
    
    virtual ~RHIObjectBase();
    
public:
    
    RHIObjectBase* AutoRelease();
