//
// Created by realxie on 2019-12-27.
//
...
public:
    ...
    {
        // static_assert(
        //     std::is_convertible<T, Ref*>::value || std::is_convertible<T, AtomicRef*>::value,
